                                        ...
                                        <div class="container">
                                            <div class="mega-menu-content clearfix">
                                                <div class="tab">
                                                    ...
                                                    <button class="tablinks" onclick="openCategory(event, 'cat04')">General</button>
                                                                ...
                                                                <div class="blog-box">
                                                                    <div class="post-media">
                                                                        <a href="tech-single.html" title="">
                                                                            ...
                                                                            <span class=" menucat">General</span>
                                                                        </a>
                                                                    </div><!-- end media -->
                                                                    <div class="blog-meta">
                    ...
                    <div class="col-lg-12">
                        <div class="page-wrapper">
                            <div class="row">
                                <div class="col-lg-5">
                                    <h4>Who we are</h4>
                                    <p>Welcome to ICU TV News, your go-to source for the latest news, insightful analysis, and compelling stories from around the world. At ICU TV News, we are dedicated to bringing you accurate, timely, and comprehensive coverage of the events that shape our world. Our team of experienced journalists and passionate storytellers work tirelessly to provide you with news that matters, delivered with integrity and professionalism.</p>
                   
                                    <h4>Our Mission?</h4>
                                    <p>Our mission at ICU TV News is to inform, educate, and engage our audience by providing high-quality journalism that upholds the highest standards of accuracy, fairness, and transparency. We strive to be a trusted source of information that empowers our viewers to make informed decisions and stay connected with the world around them.</p>
             
                                    <h2>Contact Information</h2>
                                    <h6><a>Phone Number = +260970000000</a></h6>
                                    <h6><a>Email = news@icutvzm.com</a></h6>
                                </div>
                                <div class="col-lg-7">
                    ...
                    <div class="col-lg-7">
                        <div class="widget">
                            <div class="footer-text text-left">
                                ...
                                <p>ICU TV is a News/Media Company aimed at providing only the best news content around</p>
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            ...
                            <div class="link-widget">
                                <ul>
                                    <li><a href="#">Politics <span>(21)</span></a></li>
                                    <li><a href="#">General <span>(15)</span></a></li>
                                    <li><a href="#">Entertainment <span>(31)</span></a></li>
                                    <li><a href="#">Health <span>(22)</span></a></li>
                                    <li><a href="#">Worldwide <span>(66)</span></a></li>
                                </ul>
                            </div><!-- end link-widget -->
                        </div><!-- end widget -->
                    </div><!-- end col -->
