       ...
       <div class="row">
                       ...
                       <div class="blog-box row">
                           <div class="col-md-4">
                               <div class="post-media">
                                   <a href="{{url('post_details', $post->id)}}" title="">
                           ...
                           <div class="blog-meta big-meta col-md-8">
                               <h4 href="{{url('post_details', $post->id)}}">{{$post->title}}</h4>
                               <small class="firstsmall"><a class="bg-orange" href="" title="">{{$post->category}}</a></small>
                               <small><a href="" title="">{{$post->updated_at}}</a></small>
           ...
           <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
               <div class="sidebar">
                   ...
                   <div class="widget">
                       <h2 class="widget-title">Trending Videos</h2>
